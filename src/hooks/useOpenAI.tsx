...
export function useOpenAI({
  ...
  const fetchOpenAIResponse = async (
    ...
    const instructions = isCharacter
      ? `You are ${name} from the world of Superia. Respond as a knowledgeable inhabitant or guide of that world. Stay in character, Keep things engaging, consistent, and true to the world.`
